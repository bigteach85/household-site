  ...
  return (
    <main>
      ...
      <section className="hero"><div className="hero-inner hero-layout"><div className="hero-content">
        <p className="eyebrow">THE WORLD'S FIRST RELATIONSHIP-CENTERED FAMILY LIFE PLATFORM.</p>
      ...
      <section className="network" id="people"><div className="network-inner"><div><p className="eyebrow dark-eyebrow">THE RELATIONSHIP-CENTERED DIFFERENCE</p><h2>People are not<br/><em>seats.</em></h2><figure className="household-illustration household-illustration--companionship" aria-hidden="true"><img src="/images/illustrations/household-companionship.png" alt=""/></figure></div><div className="network-copy"><p className="network-lead">Most household apps organize tasks, calendars, or files.</p><p>Household begins with the people in your life—and the relationships, responsibilities, money, documents, and care that connect them.</p><p className="network-statement">Adding Grandma shouldn't carry a price tag.</p></div></div></section>
