  ...
  return (
    <main>
      ...
      <section className="hero"><div className="hero-inner hero-layout"><div className="hero-content">
        <p className="eyebrow">THE RELATIONSHIP-CENTERED HOUSEHOLD APP.</p>
      ...
      <section className="network" id="people"><div className="network-inner"><div><p className="eyebrow dark-eyebrow">PEOPLE & RELATIONSHIPS</p><h2>People are not<br/><em>seats.</em></h2><figure className="household-illustration household-illustration--companionship" aria-hidden="true"><img src="/images/illustrations/household-companionship.png" alt=""/></figure></div><div className="network-copy"><p className="network-lead">A household is not a collection of software users. It is a living social unit.</p><p>Household is designed around the people we care for and the people we depend on.</p><p className="network-statement">Adding Grandma shouldn't carry a price tag.</p></div></div></section>
